...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.email) {
            ...
            i.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.setCompany));
            i.putExtra(Intent.EXTRA_TEXT, getString(R.string.setNextCompany));
            try {
                startActivity(Intent.createChooser(i, getString(R.string.sending)));
